  ...
  return (
    <>
      ...
      <div className="side-course bg-gray-100 gap-5 font-Poppins p-4 flex shadow-lg text-[#2761F6]">
        <h1 className="text-lg">Chapter No</h1>
          ...
          {isExpandPopupOpen && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
              <div className="bg-[#FAFAFA] relative p-6 border-[1px] border-[#FF00E5] ml-10 mt-[-20px] w-[1270px] h-[420px] shadow-[0px_0px_15px_rgba(0,0,0,0.3)]">
                <h2 className="text-lg font-semibold">{expandSource}</h2>
      ...
      {isTestVisible && (
        <div className="flex flex-col w-auto h-auto">
          <div className="test flex flex-col mt-2 ml-5 w-[1280px] h-[310px] rounded-md border-[0.68px] border-[#D6D6D6]">
            <div className="flex mt-3 w-[100px] h-[35px] rounded-md bg-gradient-to-r from-[#FF6969] to-[#C682FB] font-Poppins ml-3">
      ...
      <button
        ...
        className="bg-gradient-to-r from-[#B37FEB] to-[#B45EFF] w-[80px] h-[31px] rounded-md shadow-lg text-[#FFFFFF] mt-[530px] ml-[-80px]"
      >
        Next
      </button>
    </>
